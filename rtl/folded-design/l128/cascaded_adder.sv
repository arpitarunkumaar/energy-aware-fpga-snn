...
// Pipelined reduction tree. NUM_STAGES and OUT_WIDTH follow from NUM_INPUTS;
// IN_WIDTH defaults to 16.
module cascaded_adder #(
    ...
    // valid_out is valid_in delayed by NUM_STAGES+1 cycles (stage 0 plus the tree).
