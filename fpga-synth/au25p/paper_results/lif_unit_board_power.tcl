# usage: vivado -mode batch -source lif_unit_board_power.tcl -tclargs <label> <saif_path>
if {[llength $argv] != 2} {
    error "usage: lif_unit_board_power.tcl <label> <saif_path>"
}
...
read_saif -verbose -strip_path tb_lif_unit_board_power/dut \
...
puts "LIF_BOARD_POWER label=$label saif=$saif_path"
close_project
